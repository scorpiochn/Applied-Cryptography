 ...
 *
 * Modified by Mark Henderson April 1993 to support faster
 *   FermatTest by calling NN_2ModExp.  Define the symbol
 *   USE_2MODEXP to use this.
 */
...
#else
  NN_2ModExp (u, a, aDigits, a, aDigits);
#endif
