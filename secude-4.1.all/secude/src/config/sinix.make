...
# Check TOP !!:
TOP         = /home1/secude/secude# Path of the top-level directory of secude-4.0
...
DFLAGS      = $(DX500) $(DSTRONG) $(DSCA) $(DCOSINE) $(DAFDB) $(DTEST) $(SPECIALS) $(DSINIX)
IUCB        = -I/usr/ucbinclude # SAG: necessary for SINIX
IFLAGS      = -I/usr/include -I$(INCL) -I$(INCLISODE) $(IUCB) $(ISCA)  
AFLAGS      = -g
#AFLAGS      = -s -x
...
LIB = $(LSECUDE) $(LX500) $(LISODE) $(LSCA) $(LM) 
