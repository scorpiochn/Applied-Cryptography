...
# Check TOP !!:
TOP         = /usr/local/secude-4.0  # Path of the top-level directory of secude-4.1

# Check LDL!!:  Library path. See also ISODE-support below
LDL         = -L/libra/secude/lib -L$(TOP)/lib
...
#
# If you want to use SecuDE-4.1 on a Sun/4 with SunOS 4.1.1 and with
